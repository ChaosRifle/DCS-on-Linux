...
log.write('SRS-OverlayGameGUI', log.INFO, "Loading - DCS-SRS Overlay GameGUI - Ciribob: 2.3.4.0 ")
...
log.write('SRS-OverlayGameGUI', log.INFO, "Loaded - DCS-SRS Overlay GameGUI - Ciribob: 2.3.4.0 ")
