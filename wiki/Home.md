...
### Recommended Distros
* good picks are, but not limited to: Fedora, Arch, Ubuntu, or derivitives like Endeavour or Kubuntu. Anything NOT falling into the not-recommended list below is a sound choice.

### NOT recommended Distros
* Do not use anything [LTS](https://github.com/ChaosRifle/DCS-on-Linux/wiki/Knowledge-Base#lts-long-term-support) - LTS means old packages, and old packages means sometimes not compatible with new game updates
